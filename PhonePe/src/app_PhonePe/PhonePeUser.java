...
public class PhonePeUser {
	...
	public static void main(String []args){
		...
		BankAccount BA = new BankAccount("x1x1x1", 1500);
	...
	case 2:
		switch (src) {
		case 1:
			System.out.println("Sent Rs. "+amt+"/- from account number "+BA.getAccNo()+" to QR of UPIiD "+qr.qr);
			break;			
		case 2:
			System.out.println("Sent Rs. "+amt+"/- from account number "+BA.getAccNo()+" to mobile number"+mobNo.mobNo);
			break;
		case 3:
			System.out.println("Sent Rs. "+amt+"/- from account number "+BA.getAccNo()+" to Account number "+accNo.No);
			break;
		case 4:
			System.out.println("Sent Rs. "+amt+"/- from account number "+BA.getAccNo()+" to UPI ID "+upiId.id);
		}	
	}
